...
const Workspace = () => {
  ...
  const [contextMenuStatus, setContextMenuStatus] =
    useState<ContextMenuStatus>("none");
  ...
  const handleClick = (e) => {
    ...
    setContextMenuPosition(obj);
    setContextMenuStatus("block");
  };
  const buttonGroupMouseLeaveHandler = () => {
    setContextMenuStatus("none");
  };

  return (
    <div
      className={s.wrapper}
      onMouseLeave={buttonGroupMouseLeaveHandler}
    ...
    >
      ...
      {contextMenuStatus ? (
        <div style={contextMenuStyle} className={s.buttonGroup}>
          <button
